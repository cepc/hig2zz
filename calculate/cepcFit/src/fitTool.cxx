...
// ----------------------------------------------------------------------------------------------------- 
  ...
  RooFIter iter_c1 = w->components().fwdIterator();
  RooAbsArg* arg_c1;
  while ((arg_c1 = iter_c1.next())) {
    if (arg_c1->IsA() == RooStarMomentMorph::Class()) {
      ((RooStarMomentMorph*)arg_c1)->fixCache();
    }
  }
  ...
  RooFIter iter_c2 = w->components().fwdIterator();
  RooAbsArg* arg_c2;
  while ((arg_c2 = iter_c2.next())) {
    if (arg_c2->IsA() == RooStarMomentMorph::Class()) {
      ((RooStarMomentMorph*)arg_c2)->fixCache();
    }
  }
