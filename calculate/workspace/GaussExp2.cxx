#include "src/RooGaussExp.h"
#include "src/RooGaussExp.cxx"
...
TFile f1("out/workspace/part/ws_vvbb_inv_5.root");
RooWorkspace *w=(RooWorkspace*)f1.Get("wspace");
RooDataSet* d=(RooDataSet*)w->data("d_tot");
...
RooGaussExp::RooGaussExp *pdf=new RooGaussExp("pdf", "pdf", *inv, mH, sigma, Tn);
