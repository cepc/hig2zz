...
#        draw_signal_bg('h_vis_all_p_final',10,50,'vis_all_p_final(GeV)',combine_opt, opt,log_opt_f)
#        draw_signal_bg('h_vis_all_rec_m_final',65,105,'vis_all_rec_m_final((GeV)',combine_opt, opt,log_opt_r)
#        draw_signal_bg('h_vis_all_cos_final',-1,1,'vis_all_cos_final(GeV)',combine_opt,opt,log_opt_f)
